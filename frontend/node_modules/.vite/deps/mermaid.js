import {
  selectSvgElement
} from "./chunk-ESTKXSNJ.js";
import {
  JSON_SCHEMA,
  load
} from "./chunk-KCPJRL25.js";
import {
  registerLayoutLoaders
} from "./chunk-JC3HFQVV.js";
import "./chunk-UQQBFZJB.js";
import "./chunk-KDN3IASY.js";
import "./chunk-TNWHCC6S.js";
import "./chunk-JYPSN52Y.js";
import "./chunk-F76HOF6R.js";
import "./chunk-VF5EW4KK.js";
import {
  dedent,
  registerIconPacks
} from "./chunk-O3WYUAKW.js";
import {
  cleanAndMerge,
  decodeEntities,
  encodeEntities,
...
import {
  ...
  themes_default,
  updateSiteConfig
} from "./chunk-3NCEK3PM.js";
import {
  __name,
  log,
  select_default,
  setLogLevel
} from "./chunk-PRYFGWMH.js";
import {
  isEmpty_default
...
var loader = __name(async () => {
  const { diagram: diagram2 } = await import("./c4Diagram-IC4MRINW-ILLPI6FV.js");
...
var loader2 = __name(async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-PKNHOUZH-SFJ77AZ3.js");
...
var loader4 = __name(async () => {
  const { diagram: diagram2 } = await import("./erDiagram-INFDFZHY-SNHLC6KM.js");
...
var loader5 = __name(async () => {
  const { diagram: diagram2 } = await import("./gitGraphDiagram-K3NZZRJ6-G7EKH3PF.js");
...
var loader6 = __name(async () => {
  const { diagram: diagram2 } = await import("./ganttDiagram-A5KZAMGK-IMKDWV5R.js");
...
var loader7 = __name(async () => {
  const { diagram: diagram2 } = await import("./infoDiagram-LFFYTUFH-3ZOZ4GD4.js");
...
var loader8 = __name(async () => {
  const { diagram: diagram2 } = await import("./pieDiagram-SKSYHLDU-SSYLCOIV.js");
...
var loader9 = __name(async () => {
  const { diagram: diagram2 } = await import("./quadrantDiagram-337W2JSQ-N4HGM4SO.js");
...
var loader10 = __name(async () => {
  const { diagram: diagram2 } = await import("./xychartDiagram-JWTSCODW-HCIA3QB7.js");
...
var loader11 = __name(async () => {
  const { diagram: diagram2 } = await import("./requirementDiagram-Z7DCOOCP-NPBDPSKU.js");
...
var loader12 = __name(async () => {
  const { diagram: diagram2 } = await import("./sequenceDiagram-2WXFIKYE-AJC6XQMX.js");
...
var loader13 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-VBA2DB6C-DHQUA55L.js");
...
var loader14 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-v2-RAHNMMFH-TRWMBUPZ.js");
...
var loader15 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-RAJIS63D-AX5VNUVI.js");
...
var loader16 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-v2-FVOUBMTO-J3Z36QBN.js");
...
var loader17 = __name(async () => {
  const { diagram: diagram2 } = await import("./journeyDiagram-4ABVD52K-PQOTEZEX.js");
...
var loader19 = __name(async () => {
  const { diagram: diagram2 } = await import("./timeline-definition-YZTLITO2-YHAQSGGL.js");
...
var loader20 = __name(async () => {
  const { diagram: diagram2 } = await import("./mindmap-definition-YRQLILUH-3263WH6W.js");
...
var loader21 = __name(async () => {
  const { diagram: diagram2 } = await import("./kanban-definition-K7BYSVSG-XCJYWZTG.js");
...
var loader22 = __name(async () => {
  const { diagram: diagram2 } = await import("./sankeyDiagram-WA2Y5GQK-BOY2HR3R.js");
...
var loader23 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-P4PSJMXO-XAQZ3W5F.js");
...
var loader24 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-IFDJBPK2-NU7UG3FA.js");
...
var loader25 = __name(async () => {
  const { diagram: diagram2 } = await import("./blockDiagram-WCTKOSBZ-KYUFHHB4.js");
...
var loader26 = __name(async () => {
  const { diagram: diagram2 } = await import("./architectureDiagram-2XIMDMQ5-3POI5TAZ.js");
...
var loader27 = __name(async () => {
  const { diagram: diagram2 } = await import("./ishikawaDiagram-PHBUUO56-SQZF4VYW.js");
...
var loader28 = __name(async () => {
  const { diagram: diagram2 } = await import("./vennDiagram-LZ73GAT5-22EC7J7I.js");
...
var loader29 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-E7M64L7V-OH7SPU7B.js");
